...
$conf['capcha'] = 0;
/***
* Использовать шаблон отправки на почту, найти его можно по следующему пути 'backformer/config/НАЗВАНИЕ_ВАШЕГО_КОНФИГА/report.tpl';
* Где плейсхолдер, например, [+email+] — это значение атрибута 'name' тега <input>
*   1 - будет браться из шаблона
***/
$conf['body'] = 1;
/***
* локализация
